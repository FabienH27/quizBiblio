    ...
    return (
      <div className="flex text-white my-5">
        <div>
          ...
          <div className="bg-gray-800  text-center py-5 px-8 flex font-display text-xl rounded-lg">
            <input
              type="text"
        ...
        <div className="flex text-white items-center mt-8" id="localImage">
          ...
          <div className="flex self-center">
            <input type="file" className="fileProposition" />
            <label
              htmlFor="file"
...
class Upload extends React.Component {
  ...
  handleChange(event,selectorFiles, newValue) {
    this.setState({
      hasImage: true,
