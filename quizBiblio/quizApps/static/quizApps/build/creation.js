...
var CreationMenu = function (_React$Component) {
  ...
  _createClass(CreationMenu, [{
    ...
    value: function render() {
      ...
      return React.createElement("div", { className: "my-5" }, this.displayQuestion, React.createElement("div", { className: "flex 3xl:max-w-7xl max-w-3xl mx-auto justify-end font-title py-12" }, React.createElement("button", { onClick: this.appendQuestion, type: "button", className: "text-white mx-2 bg-teal-500 px-5 py-2 rounded-md 3xl:px-8 3xl:py-5 3xl:text-2xl hover:bg-teal-600 focus:outline-none" }, "Ajouter une question"), React.createElement("button", { onClick: this.removeQuestion, type: "button", className: "text-white mx-2 bg-teal-500 px-5 py-2 rounded-md 3xl:px-8 3xl:py-5 3xl:text-2xl hover:bg-teal-600 focus:outline-none" }, "Supprimer une question"), React.createElement("button", { type: "submit", className: "text-white mx-2 bg-teal-500 px-5 py-2 rounded-md 3xl:px-8 3xl:py-5 3xl:text-2xl hover:bg-teal-600 focus:outline-none" }, "Valider le quiz")));
    }
  }]);
...
var Question = function (_React$Component2) {
  ...
  _createClass(Question, [{
    ...
    value: function render() {
      ...
      return React.createElement("article", { className: "p-5" }, React.createElement("div", { className: "max-w-2xl mx-auto 3xl:max-w-screen-xl" }, React.createElement("div", { className: "flex font-display text-white" }, React.createElement("h1", { className: "text-2xl my-5 3xl:text-4xl" }, "Question " + (this.props.id + 1))), React.createElement("div", { className: "flex text-white", id: "localImage" }, React.createElement("svg", {
      ...
      })), React.createElement("div", { className: "flex self-center" }, React.createElement(Upload, { id: "file", name: "imageQ" + (this.props.id + 1) }))), React.createElement("textarea", {
      ...
      }))), React.createElement("div", { className: "flex flex-wrap max-w-2xl 3xl:max-w-7xl self-center justify-evenly mx-auto " }, this.displayProposition), React.createElement("div", { className: " max-w-xl mx-auto font-display mt-8" }, React.createElement("textarea", {
...
var Propositions = function (_React$Component3) {
  ...
  _createClass(Propositions, [{
    ...
    value: function render() {
      ...
      if (!hasImage) {
        this.state.content = React.createElement("div", { className: "flex justify-center items-center" }, React.createElement("textarea", {
          rows: 1, maxLength: 50,
        ...
        contentImage = React.createElement("div", null, React.createElement("input", {
          ...
          className: "cursor-pointer md:w-40 3xl:text-xl" }, "Remplacer par une image"));
      } else {
        this.state.content = React.createElement("div", null, React.createElement("img", { src: this.state.file, className: "w-48" }));
        contentImage = React.createElement("button", { onClick: this.handleDeleteClick, className: "hover:text-teal-500 focus:outline-none" }, "Supprimer l'image");
      }

      return React.createElement("div", { className: "text-white mt-8 flex items-center 3xl:w-6/12 justify-center" }, React.createElement("div", null, React.createElement("div", { className: "flex justify-between items-center prop" }, React.createElement("div", { className: "items-start flex" }, React.createElement("div", { className: "flex text-white items-center w-36 3xl:w-80", id: "localImage" }, React.createElement("svg", {
        xmlns: "http://www.w3.org/2000/svg",
        className: "h-12 w-12",
        fill: "none",
        viewBox: "0 0 24 24",
      ...
      }), React.createElement("label", { htmlFor: "prop" + this.props.id, className: "flex" }, React.createElement("p", { className: "text-sm mr-1 text-center 3xl:text-xl" }, text), React.createElement("svg", {
        xmlns: "http://www.w3.org/2000/svg",
        className: "h-6 w-6",
        fill: "none",
        viewBox: "0 0 24 24",
      ...
      }))))), React.createElement("div", { className: "bg-gray-800 text-center py-5 px-8 font-display text-xl rounded-lg" }, this.state.content)));
    }
  }]);
...
var Upload = function (_React$Component4) {
  ...
  _createClass(Upload, [{
    ...
    value: function render() {
      ...
      var text = void 0;
      if (!hasImage) {
        text = React.createElement("div", null, React.createElement("input", {
          type: "file",
          ...
          htmlFor: "file",
          className: "cursor-pointer ml-5 md:w-40 3xl:text-3xl" }, "Charger une image"));
      } else {
        text = React.createElement("div", null, React.createElement("button", { onClick: this.handleDeleteClick, className: "3xl:text-3xl" }, "Supprimer image"), React.createElement("span", { className: "file-name font-light ml-8 3xl:text-3xl text-white" }, this.state.infos));
      }

      return React.createElement("div", { className: "flex flex-col justify-center self-center place-items-center mx-auto" }, text, React.createElement("img", { src: this.state.file, width: "50%", className: "mt-2" }));
    }
  }]);
...
var InputNumber = function (_React$Component5) {
  ...
  _createClass(InputNumber, [{
    key: "render",
    value: function render() {
      return React.createElement("div", { className: "flex" }, React.createElement("h1", { className: "w-28 text-right mr-2 inline text-white font-display leading-5 my-auto 3xl:text-xl" }, "Nombre de propositions"), React.createElement("div", { className: "inline-flex items-center border-2 border-gray-500 rounded-md bg-gray-800 w-20" }, React.createElement("span", { className: "px-3 text-gray-400 w-10 text-center bg-gray-800" }, this.props.count), React.createElement("div", { className: "flex flex-col ml-4 text-gray-500 border-l-2 py-1 border-gray-500" }, React.createElement("button", {
        type: "button",
